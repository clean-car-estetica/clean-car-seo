...
export const servicos: Service[] = [
  ...
  { slug: "revitalizacao-plastico", nome: "Revitalização de Plástico", resumo: "Plásticos externos de volta à cor original.", descricao: "Renovamos plásticos externos desbotados pelo sol (para-choques, molduras, retrovisores), devolvendo a cor preta original e protegendo contra o ressecamento — o detalhe que muda a aparência do carro de longe.", duracao: "30min", precoDesde: 80, imagem: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=800&q=80" , ordem: 10 },
  { slug: "cristalizacao-de-vidros", nome: "Cristalização de Vidros", resumo: "Descontaminação e proteção contra chuva ácida.", descricao: "Descontaminação e tratamento hidrofóbico dos vidros com Glasy Vonixx — repele água e sujeira, melhora a visibilidade em dias de chuva, protege contra manchas de chuva ácida e facilita a limpeza no dia a dia.", duracao: "1h", precoDesde: 110, imagem: "https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?auto=format&fit=crop&w=800&q=80" , ordem: 11 },
