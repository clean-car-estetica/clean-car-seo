...
export const processoPadrao: PassoDB[] = [
  ...
  { id: -5, titulo: "Produtos Vonixx do início ao fim", texto: "Química de ponta em cada etapa da lavagem e da higienização." },
];
...
export const faqsPadrao: FaqDB[] = [
  {
    ...
    resposta:
      "Depende do serviço. Uma higienização geralmente leva algumas horas — no agendamento a gente já informa o prazo certo.",
  },
  {
    id: -4,
